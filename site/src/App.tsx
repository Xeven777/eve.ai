    ...
    <main className="relative">
      ...
      <Floating className="flex flex-col items-center px-4 relative overflow-hidden pb-96">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-8xl serif mt-32 md:mt-40 text-center font-medium tracking-tighter mb-6 motion-duration-1000 motion-preset-blur-up pointer-events-none">
          Reconnect with the
          <SparklesText
            className="text-pink-500 italic font-light"
            text="Ones"
          />
          <br />
          you
        ...
        <FloatingElement depth={0.8} className="absolute top-20 left-16">
          <img
            src={img4}
            alt="img"
        ...
        <FloatingElement depth={0.8} className="absolute top-16 right-14">
          <img
            src={img5}
            alt="img"
            className="object-cover size-64 rotate-12"
          />
        </FloatingElement>
